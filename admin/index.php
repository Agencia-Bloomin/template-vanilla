...
$router->get("/multiples-auto", "ProductMassive:multipleAutoAdd");
$router->post("/multiples-auto", "ProductMassive:multipleAutoAdd");
$router->get("/multiples-excel", "ProductMassive:multipleExcelAdd");
$router->post("/multiples-excel", "ProductMassive:multipleExcelAdd");
