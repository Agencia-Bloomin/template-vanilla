    ...
    <div class="login <?= ($block == true) ? 'block' : '' ;?>"  style='background-image: url(<?=url("/theme/assets/images/bg-login.webp")?>)'>
        <article class="login_box radius">
            ...
            <input type='hidden' name='csrf_token' value='<?=$token?>'>
                ...
                <!-- <input type="submit" value="Entrar" class="radius gradient gradient-bloomin gradient-hover icon-sign-in"> -->


                <button class="radius gradient gradient-bloomin gradient-hover icon-sign-in" type="submit">Entrar</button>
            ...
            <footer>
                <p>Desenvolvido por www.<b>bloomin</b>.com.br</p>
